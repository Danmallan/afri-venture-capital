      ...
      <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
        <div class="lg:ml-auto lg:pl-4 lg:pt-4">
          <div class="lg:max-w-lg">
            <p class="mb-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Toomti</p>
            <h2 class="mb-2 text-base font-semibold leading-7 text-indigo-600">AI-Powered Growth Platform for Real Estate Success</h2>
